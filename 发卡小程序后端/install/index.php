...
<nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        <span class="navbar-brand">灵思发卡安装向导</span>
      </div>
    </div>
  </nav>
...
<div class="panel panel-primary">
	<div class="panel-heading" style="background: #15A638;">
		<h3 class="panel-title" align="center">灵思发卡</h3>
	</div>
	<div class="panel-body">
		<p><iframe src="http://blog.ailingsi.top/" style="width:100%;height:465px;"></iframe></p>
		<?php if($installed){ ?>
